...
class _AnimatedTextState extends State<AnimatedText>
  ...
  List<List<String>> separatedStrings = <List<String>>[];
  ...
  Map<String, List<String>> preProcesedFadeOut = <String, List<String>>{};
  Timer? _timer;
  ...
  _processWords() {
    ...
    for (int i = 0; i < len; i++) {
      ...
      List<String> fadeIn = <String>[];
      List<String> fadeOut = <String>[];
        ...
        children: widget.alphabets!.toList().asMap().entries.map((e) {
          ...
          return AnimatedBuilder(
              ...
              builder: (context, snapshot) {
                ...
                double asd = widget.fadeAnimation!.value;
